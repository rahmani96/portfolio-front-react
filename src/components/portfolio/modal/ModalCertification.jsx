...
const ModalCertification = ({ imageLength, setGetModal }) => {
    var settings = {
            dots: true,
            infinite: true,
            speed: 500,
    ...
    if (imageLength == 1) {
        return (
            <div className="modal_portfolio ">
                ...
                {PortfolioData.filter((item) => item.id === imageLength).map((item) => {
                    return (
                        ...
                        {item.modalDetails.map((details, i) => {
                            ...
                            <div key={i} className="row open-sans-font">
                                ...
                                <div className="col-12 col-sm-6 mb-2">
                                    ...
                                    Preview :{" "}
                                    <a className="preview-link" target="_blank" rel="noopener noreferrer nofollow" href={details.link}>
                                        {details.preview}
                                    </a>
                                </div>
                            </div>
            ...
            <div className="modal_portfolio">
                ...
                {PortfolioData.filter((item) => item.id === imageLength).map((item) => {
                    ...
                    <div key={item.id} data-aos="fade">
                        ...
                        <figure className="modal__img">
                            <Slider {...settings}>
                                <div><img src={item.image} alt="portfolio project demo" /></div>
                                <div><img src={img1} alt="portfolio project demo" /></div>
                                <div><img src={img2} alt="portfolio project demo" /></div>
                            </Slider>
                        </figure>
